...
function initializeMatches() {
  const roundOf16Matches = [
    ...
    { id: 6, round: 'round_of_16', teams: [teams[10], teams[11]], winner: null },
    { id: 7, round: 'round_of_16', teams: [teams[12], teams[13]], winner: null },
    { id: 8, round: 'round_of_16', teams: [teams[14], teams[15]], winner: null },
  ]
